...
<section class="sidebar bg-light">
  <div class="sidebar-header border-bottom px-2 py-3">
    <div class="d-flex user_details"> <img width="70" class="filter-gray opacity25 my-auto border border-secondary rounded-circle" style="border-radius:50%;" src="<?= base_url(); ?>/assets/static/img/ama/ama-128x128.png">
