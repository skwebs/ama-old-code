...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2021 at 11:21 AM
...
INSERT INTO `students_reg` (`id`, `reg_num`, `first_name`, `mid_name`, `last_name`, `mother_name`, `father_name`, `gender`, `dob`, `mobile`, `email`, `aadhaar`, `blood_group`, `category`, `religion`, `nationality`, `student_img`, `address1`, `address2`, `contact_person`, `cp_name`, `cp_rel`, `mother_occup`, `mother_qual`, `mother_mob`, `father_occup`, `father_qual`, `father_mob`, `income`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1613902625, 'Satish', 'Kumar', 'Sharma', 'Anita Devi', 'Bindeshwar Prasad Shrama', 'Male', '2021-02-21', 9973757920, '00satish2015@gmail.com', 0, '', 'Sc/st', 'Hindu', NULL, 'assets/dynamic/student/img/1613902625_img_60323321ee220.png', 'At- Bhatha Dasi, ', 'At- Bhatha Dasi, ', 'Parents', NULL, NULL, 'House Wife', 'Post Graduation', 9525838766, 'Govt. Job', 'Post Graduation', 9535491061, 1200000, '2021-02-21 04:17:05', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tmp_students_reg`
--
...
--
-- Indexes for table `tmp_students_reg`
--
ALTER TABLE `tmp_students_reg`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tmp_students_reg`
--
ALTER TABLE `tmp_students_reg`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
