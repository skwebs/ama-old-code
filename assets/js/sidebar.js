...
function navBreakpoint() {
    if (nav.hasClass("navbar-expand-sm")) {
        navExpandBreakpoint = "sm";
        return 576;
    } else if (nav.hasClass("navbar-expand-md")) {
        navExpandBreakpoint = "md";
        return 768;
    } else if (nav.hasClass("navbar-expand-lg")) {
        navExpandBreakpoint = "lg";
        return 992;
    } else if (nav.hasClass("navbar-expand-xl")) {
        navExpandBreakpoint = "xl";
        return 1200;
    }
}
$("sidebar").addClass("d-" + navExpandBreakpoint + "-none")
